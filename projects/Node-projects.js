export function NodeProjects() {
    
    return  (
        `<div class="project-card news-card" data-link-web="https://fcc-personal-library-847.herokuapp.com/" data-link-gitHub="https://github.com/AugustoSoria/fcc-personal-library">
            <img src="img/projects/personal-library.png" class="card-img-top" alt="personal-library project">
            <div class="card-body">
        ...
        <div class="project-card news-card" data-link-web="https://exercise-tracker-894.herokuapp.com/" data-link-gitHub="https://github.com/AugustoSoria/fcc-exercise-tracker">
            <img src="img/projects/exercise-tracker.png" class="card-img-top" alt="personal-library project">
            <div class="card-body">
                <div class="tech-img-container">
                    <img style="width: 30px;" src="img/skills/node.png"/>
                    <img style="width: 30px;" src="img/skills/mongodb.png"/>
